...
import img1 from '@/assets/temp/home/20.jpg';
import img2 from '@/assets/temp/home/19.jpg';
import img3 from '@/assets/temp/home/18.jpg';
import img4 from '@/assets/temp/home/17.jpg';

export const hanDynastyThird = defineStore('hanThird', {
  state: () => {
    return {
      articles: [
        {
          id: 0,
          title: '无官的世界',
          desc: '东汉建武年间，刘秀裁撤了全国90%的官僚，全国三分之一的县根本没有县.令。至于盐铁官营、平准均输、冶铁铸币，刘秀确实没有明确废黜，这些衙门却.根本无人办公。',
          img: img1,
          paragraphs: [
        ...
        },
        {
          id: 1,
          title: '钱断桃花源',
          desc: '为一劳永逸地解决西羌问题，汉安帝刘祜举全国之力对西羌发动了一场旷日持久的战争。与汉武帝直接派兵征伐匈奴不同，汉安帝无论是征发士兵，还是屯兵边境，都要依靠富可敌国的坞堡。。',
          img: img2,
          paragraphs: [
        ...
        },
        {
          id: 2,
          title: '铜臭的由来?',
          desc: '或许汉灵帝认为，帝国已经出现了“三空”( 田野空、府库空、朝廷空),既然封建官吏没有实权，卖掉又有何妨?卖官不用盘剥百姓，又能增加国库收入，这才是敛财的最佳手段。何乐而不为?',
          img: img3,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 3,
          title: '无字的小钱',
          desc: '董卓之错，在于他明明是土匪，却偏偏以国家名义发行无字小钱。与其说无字小钱打破了人们对货币的信任，毋宁说自此封建帝国的信誉完全崩溃。封建帝国已经完全成为强盗，再也没有一个土匪能取得黎民百姓的信任。',
          img: img4,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
