...
import img1 from '@/assets/temp/home/31.jpg';
import img2 from '@/assets/temp/home/30.jpg';
import img3 from '@/assets/temp/home/29.jpg';
import img4 from '@/assets/temp/home/28.jpg';

export const hanDynasty = defineStore('han', {
  state: () => {
    return {
      articles: [
        {
          id: 0,
          title: '汉初大通胀',
          desc: '刘邦大概没有想到，他的土地政策奠定了此后两千年的社会结构:皇帝是社.会最高层，具有至高无上的权力;皇帝之下是三公九卿等封建官僚，拿皇帝的钱，逐级管理小农;最底层是万千小农，他们对帝国纳税，用自己的血汗钱养活帝王与封建官僚。',
          img: img1,
          paragraphs: [
        ...
        },
        {
          id: 1,
          title: '盛世铸私钱',
          desc: '皇帝在自己地盘上大搞各种“减税、劝农”运动，连刘恒自己都亲自跑到地里种庄稼，诸侯如果先落了下风，那皇帝干脆也不用“削藩”了。出于“削藩的危机感，更出于获得优势经济的动机，诸侯对振兴封国经济的渴盼远甚于皇帝刘恒，很多成绩也是汉郡所无。',
          img: img2,
          paragraphs: [
        ...
        },
        {
          id: 2,
          title: '汉初之梦',
          desc: '为挽救濒于崩溃的汉帝国的财政，汉帝国又一次推出了货币改革。在诏书中，刘彻毫不掩饰地说明了本次货币改革的目的:弥补日益浩繁的战争开支，借推行新币禁商人之利。',
          img: img3,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 3,
          title: '抢劫无极限',
          desc: '在“不告缗令”的引导下，有钱人很自然就发现了一个低风险、高收益的渠道一土地!随着商人手中大量的货币迅速转向土地，汉帝国第一波土地兼并运动开始了。结果不言而喻，儒学大师董仲舒给出了那句最精准的评价:“富者连阡陌，贫者无立锥之地。”',
          img: img4,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
