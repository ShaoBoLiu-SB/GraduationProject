...
import img1 from '@/assets/temp/home/15.jpg';
import img2 from '@/assets/temp/home/17.jpg';
import img3 from '@/assets/temp/home/16.jpg';
import img4 from '@/assets/temp/home/19.jpg';

export const nanDynasty = defineStore('nanDynasty', {
  state: () => {
    return {
      articles: [
        {
          id: 0,
          title: '生而不平',
          desc: '现在，刘裕已经是皇帝，他不能容忍士族高门如此放肆。在皇权眼里，没有朋友，也不会有敌人，只有“被统治的人”和“不被统治的人”。士族高门之所以高高在上，不就是因为有钱就不想被皇权统治吗?',
          img: img1,
          paragraphs: [
        ...
        },
        {
          id: 1,
          title: '钱财断手足',
          desc: '据《宋书》记载，当时的封建官僚那是相当有钱:宁州刺史萧惠开家财数亿钱,益州刺史刘郡以黄金铸造浴盆。《南史》中绝大部分刘宋官僚都有这样的绰号:刺史一级的经常被人称为“孙亿万”“刘千万”,县令一级的则被人称为“王新车”、“庾大宅”.....',
          img: img2,
          paragraphs: [
        ...
        },
        {
          id: 2,
          title: '全民高利贷',
          desc: '刘宋、萧齐是封建官僚长成的时代，萧齐一如刘宋王朝，封建官僚新贵几乎垄断了所有创新行业，所有真正赚钱的投资渠道都被封建官僚堵死，上古时代又没有资产泡沫可以制造，剩余货币也就只能投资高利贷了。',
          img: img4,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 3,
          title: '萧齐祸福',
          desc: '梁武帝丝毫不知控制封建官僚的力量，封建官僚中迟早会生出擎天巨孽。不是这些民贼贪婪、狡诈、阴险，而是黎民百姓已经羸弱不堪，根本不足以支撑一个王朝了。很快，萧梁王朝的惩罚者就出现了一侯景。',
          img: img3,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
