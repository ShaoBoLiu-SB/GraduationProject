...
import img1 from '@/assets/temp/home/1.jpg'
import img2 from '@/assets/temp/home/2.jpg'

export const zhouDynasty = defineStore('zhou', {
  state: () => {  
    return {
      articles: [
        {
          id: 0,
          title: '恩惠能换来忠诚吗',
          desc: '对权力没有任何制约的西周，“王德”是封建统治者最后的底线。这种“王德"对天命的畏惧延续了周王朝近千年的生命，此后，无论春秋五霸如何强盛，都只能挟天子以令诸侯，再强的诸侯都必须获得王室认可。',
          img: img1,
          paragraphs: [
