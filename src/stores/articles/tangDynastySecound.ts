...
import img1 from '@/assets/temp/home/32.jpg';
import img2 from '@/assets/temp/home/31.jpg';
import img3 from '@/assets/temp/home/30.jpg';
import img4 from '@/assets/temp/home/29.jpg';

export const tangDynastySecound = defineStore('tangDynastySecound', {
  state: () => {
    return {
      articles: [
        {
          id: 0,
          title: '钱味甘, 大热有毒',
          desc: '开元初年，在以张说为首的封建官僚轮番炒作之下，大唐帝国的土地价格开始了一轮螺旋式飙升，即使贫瘠土地的价格也是武后年间沃壤价格的数倍。一批封建官僚却获得了“多田翁"、“地癖”一类的绰......',
          img: img1,
          paragraphs: [
        ...
        },
        {
          id: 1,
          title: '开元限购令',
          desc: '这项土地限购政策在唐史中被称为“检田括户”，是一剂完全违反玄宗“无为而治”治国精神的猛药，唐玄宗希望以皇权铁腕确保帝国在“耕者有其田”的轨道上运行。如此生猛的限购政策，是一定会往死里得罪封建官僚的。',
          img: img2,
          paragraphs: [
        ...
        },
        {
          id: 2,
          title: '朱门酒肉臭,路有冻死骨',
          desc: '《通鉴》记载,天宝十四年(公元755年),大唐帝国共有八百九十一万四千七百户农人，其中三百五十六万五千五百户已经丧失了土地，沦为“庄客”，也就是说，全国40%以.上的人已经彻底失去了自己的土地。杜甫“朱门酒肉臭，路有冻死骨”的诗篇，就是写于天宝十四年。',
          img: img3,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 3,
          title: '《李娃传》中的金融故事',
          desc: '.《李娃传》之所以重要，是因为它揭示了一个盛世必备的重要特征:贫贱者可因奋斗而富贵，富贵者亦可因浪荡而贫贱，整个社会阶层上下之间是可以自由流动的。',
          img: img4,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
