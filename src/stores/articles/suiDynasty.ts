...
import img1 from '@/assets/temp/home/41.jpg';
import img2 from '@/assets/temp/home/40.jpg';
import img3 from '@/assets/temp/home/39.jpg';
import img4 from '@/assets/temp/home/38.jpg';
import img5 from '@/assets/temp/home/37.jpg';

export const suiDynasty = defineStore('suiDynasty', {
  state: () => {
    return {
      articles: [
        {
          id: 0,
          title: '壮哉盛隋',
          desc: '各郡均有如此多的粮食，开皇四年(公元584年)关中大旱,隋文帝官殿中的粮食居然不够吃，只得率领文武百官一起逃奔洛阳(一说出关中就食),后世也有人将隋文帝讥讽为“逐粮天子”。',
          img: img1,
          paragraphs: [
        ...
        },
        {
          id: 1,
          title: '隋五铢的奇迹',
          desc: '观张威所作所为，充其量也就是个奸商。这件事情被门下省的御史.上奏给隋文帝，经门下省合议，判定张威有罪，愣是因此将张威一个堂堂“省部级干部”削职为民。',
          img: img2,
          paragraphs: [
        ...
        },
        {
          id: 2,
          title: '隋炀帝的国际贸易',
          desc: '在这种有损大隋帝国经济利益的国际贸易中，获得贸易特许权的西域诸国可以源源不断地得到隋朝的好处。既然已经获得了好处，这些部落也就必然切断了和西突厥、吐谷浑的往来。游牧民族化整为零，也就失去了挑战大隋帝国的实力。',
          img: img5,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 3,
          title: '尽到隋亡为此河',
          desc: '江南商人从这条运河上获益更多。一条让江南获益更为巨大的运河，隋炀帝却选择完全在江北沿岸征调民夫和粮食，也就是说，这条河的成本基本上全部压在江北黎民身上了.....',
          img: img3,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 4,
          title: '白钱的故事',
          desc: '对隋王朝来说，北方经济不如南国，这本不是一个问题，经济不好，慢慢建设就是了。封建官僚虽然聚敛无度，却是支持帝国统治北方的中坚，失去了关陇十族的支持。大隋帝国的气数也就尽了。',
          img: img4,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
