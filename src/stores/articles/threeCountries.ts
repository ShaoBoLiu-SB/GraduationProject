...
import img1 from '@/assets/temp/home/10.jpg';
import img2 from '@/assets/temp/home/15.jpg';
import img3 from '@/assets/temp/home/16.jpg';
import img4 from '@/assets/temp/home/17.jpg';

export const threeCountries = defineStore('threeCountries', {
  state: () => {
    return {
      articles: [
        {
          id: 0,
          title: '曹操"隆中对"',
          desc: '聪明人不止曹操一个，所有军阀都想空手套白狼，都在招募流民。只不过，店大欺客，多数军阀并不在乎流民的生命，甚至不在乎生产多少粮食，他们只在乎自己占有多少土地。在他们眼里,流民是部曲、是任人蹂躏的奴隶,不要说分成，流民经常连自己都养不活。',
          img: img1,
          paragraphs: [
        ...
        },
        {
          id: 1,
          title: '曹操土改',
          desc: '把曹操跟王莽并列在一起，还是相当有道理的。曹操的《置屯田令》《抑兼并令》跟王莽的“王田制”根本就是一回事:国家对小农发放土地，小农直接向.国家缴纳地租。推行“耕者有其田”当然会得罪那帮封建官僚，而且这些人掌握着后世史笔。',
          img: img2,
          paragraphs: [
        ...
        },
        {
          id: 2,
          title: '悠悠我心, 不负五铢?',
          desc: '曹操把铸造货币的权力留给了民间，铸造货币的人也许是商人，也许是坞堡，甚至可能是小军阀。无论铸造者是谁，只要所铸货币能在流通中得到认可，就得到官方允许。',
          img: img3,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 3,
          title: '祭坛上的蜀汉',
          desc: '刘备铸造的货币叫作“直百五铢”,最初重十克左右,约是原蜀地五铢的三倍，却要当一百枚蜀地五铢用。这说白了就是铸造大钱，以三四十分之一的成本去抢劫蜀地的粮食、布匹乃至所有财富。',
          img: img4,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
