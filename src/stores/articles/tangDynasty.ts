    ...
    return {
      articles: [
        ...
        },
        {
          id: 1,
          title: '无字碑上的轮回',
          desc: '真实的武则天，究竟是什么样子的呢?在回答这个问题前，我们先简要回顾汉武帝年间的盛衰循环,因为武则天当政期间的政策,完全是汉武帝政策的2.0版。',
          img: img2,
          paragraphs: [
        ...
        },
        {
          id: 2,
          title: '金简除罪',
          desc: '这里要说明的不是武则天如何授田，即使我们找到更多资料，也不过是证明她在步吕后的后尘。武则天最大的功绩并不在农业，而在振兴商业。她的父亲本是一个倒卖木材的商人，也是在这种家庭中，武则天了解了商人最怕的一件事一关津。',
          img: img3,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
        ...
        },
        {
          id: 3,
          title: '官无事,民自富',
          desc: '在唐史中，裁撤官营手工业是继武后减税后的又一决定性举措，为大唐强盛的手工业缔造了坚实的基础。此后两三年，大唐帝国手工业、商业的发展进入了中国历史上的又一个巅峰时期。',
          img: img4,
          paragraphs: [
            '西周王朝灭亡之后的两千多年里，人们不断思索:若诚如孔子所言，西周是一个政治清明、道德高尚、制度合理的王朝，为何这样的王朝也会在历史长河中湮灭?',
            '答:如果没有外敌，那么西周王室很有可能成为千年- -系的中华帝王家族，中华的历史可能会被完全改写。遗憾的是,历史不容假设,周王朝的西部有-一个强大的异族一犬戎，这个民族的存在使得西周依靠“王德”维持统治的愿望注定要落空。',
