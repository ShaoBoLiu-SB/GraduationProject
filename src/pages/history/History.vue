...
import { onMounted, computed, ref, toRaw, onUnmounted } from "vue";
...
const dynastyList = [qinDynastyStore, tangDynastyStore, mingDynasty1Store, hanDynastySecoundStore, hanDynastyThirdStore, threeCountriesStore, twoJinDynastyStore, nanDynastyStore, suiDynastyStore, tangDynastyStore, tangDynastySecoundStore, tangDynastyThirdStore]
